...
// what it do?
use peaq_primitives_xcm::{Balance, currency::CurrencyId, evm::EvmAddress};
...
// where
// 	Runtime:
// 		orml_currencies::Config + pallet_evm::Config + module_prices::Config + pallet_transaction_payment::Config,
// 	orml_currencies::Pallet<Runtime>: MultiCurrencyT<Runtime::AccountId, CurrencyId = CurrencyId, Balance = Balance>,
// {
...
// 				let balance = if currency_id == <Runtime as pallet_transaction_payment::Config>::GetNativeCurrencyId::get()
// 				{
// 					<Runtime as pallet_evm::Config>::Currency::free_balance(&who)
// 				} else {
// 					<Runtime as orml_currencies::Config>::MultiCurrency::total_balance(currency_id, &who)
// 				};
...
// 				// transfer weight
// 				let weight = if currency_id == <Runtime as pallet_transaction_payment::Config>::GetNativeCurrencyId::get()
// 				{
