...
/// Weights for module_asset_registry using the Peaq node and recommended hardware.
pub struct PeaqWeight<T>(PhantomData<T>);
impl<T: frame_system::Config> WeightInfo for PeaqWeight<T> {
